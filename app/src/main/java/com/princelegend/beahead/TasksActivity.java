...
public class TasksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigation = (MeowBottomNavigation) findViewById(R.id.bottomNavig);
            ...
            public void onShowItem(MeowBottomNavigation.Model item) {
                ...
                switch (item.getId()){
                    case 1:
                        ...
                        fragment = new UpcomingTasksFragment();
                        break;
                    case 2:
                        // when id is 2
        ...
        bottomNavigation.setOnClickMenuListener(new MeowBottomNavigation.ClickListener() {
            ...
            public void onClickItem(MeowBottomNavigation.Model item) {
                switch (item.getId()) {
                    case 1:
                        Toast.makeText(TasksActivity.this,"Upcoming Tasks!",Toast.LENGTH_SHORT).show();
                        break;

                    case 2:
                        Toast.makeText(TasksActivity.this,"Home!",Toast.LENGTH_SHORT).show();
                        break;

                    case 3:
                        Toast.makeText(TasksActivity.this,"Completed Tasks!",Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        });
