...
public class CompletedOnlineEventsAdapter extends RecyclerView.Adapter<CompletedOnlineEventsAdapter.MyViewHolder> {
    ...
    public CompletedOnlineEventsAdapter(Context context, ArrayList<OnlineEvents> list) {
                                    ...
                                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            for(OnlineEvents o : deleteList) {
                                                ...
                                                Query query = reff.child("users").child(uid).child("oEvents").child("completed").orderByChild("onlineName").equalTo(o.getOnlineName());
