...
public class CompletedTasksAdapter extends RecyclerView.Adapter<CompletedTasksAdapter.MyViewHolder> {
    ...
    ArrayList<Tasks> selectedList = new ArrayList<>();

    public CompletedTasksAdapter(Context context, ArrayList<Tasks> list) {
    ...
    private void clickItem(MyViewHolder holder) {
        // get selected item
        Tasks tasks = filteredList.get(holder.getAdapterPosition());
        // check condition
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(isEnabled) {
                    ...
                    intent.putExtra("taskName",filteredList.get(position).getName());
                    intent.putExtra("taskDate",filteredList.get(position).getDate());
                    intent.putExtra("taskTime",filteredList.get(position).getTime());
                        ...
                        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
                            ...
                            switch (id) {
                                case R.id.menu_delete:
                                    ArrayList<Tasks> deleteList = new ArrayList<>();
                                    ...
                                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            for(Tasks t : deleteList) {
                                                // delete from database
                                                Query query = reff.child("users").child(uid).child("Tasks").child("completed").orderByChild("name").equalTo(t.getName());
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if(key.isEmpty()) {
                    ...
                    ArrayList<Tasks> listFiltered = new ArrayList<>();
                    for(Tasks row : list) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                filteredList = (ArrayList<Tasks>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }
