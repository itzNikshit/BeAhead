...
public class NormalEventsAdapter extends RecyclerView.Adapter<NormalEventsAdapter.MyViewHolder> {
    ...
    public NormalEventsAdapter(Context context, ArrayList<NormalEvents> list) {
                                    ...
                                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            for(NormalEvents n : deleteList) {
                                                ...
                                                Query query = reff.child("users").child(uid).child("nEvents").child("upcoming").orderByChild("eventName").equalTo(n.getEventName());
